...
const ProjectsCard = ({ img, url, title, text, github, id, slide }: ProjectType) => {
  ...
  return (
    <article className="bg-primary-white rounded-lg shadow-md hover:shadow-2xl duration-300">
      ...
      <Dialog title={title} id={id} url={url} img={img} text={text} github={github} slide={slide} dialogRef={dialogRef} close={close} />
    </article>
  )
}
